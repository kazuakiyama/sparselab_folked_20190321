...
class VisTable(UVTable):
    ...
    def chisq_image3d(self, imfitslist, mask=None, amptable=False, istokes=0, ifreq=0, Nf=2):
        # calcurate chisqared and reduced chisqred.
    ...
    def _call_fftlib3d(self, imfitslist, mask, amptable, istokes=0, ifreq=0, Nf=2):
        # get initial images
        istokes = istokes
        ifreq = ifreq
